...
def colour_agents_SS(agent_data):
    agent_data["loc"] = np.where(
        agent_data["moving"],
        np.where(agent_data["charge"] < 25, "black", "blue"),
        np.where(
            agent_data["last_location"] < "home",
            "red",
            np.where(
                agent_data["last_location"] < "work",
                "green",
                np.where(
                    agent_data["last_location"] < "charge",
                    "teal",
